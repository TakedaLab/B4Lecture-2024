...
def parse_args():
    ...
    parser.add_argument("--input-file", type=str, required=True, help="name of input wav file")
...
if __name__ == "__main__":
    ...
    filtered_spectrogram = ex1.create_spectrogram(filtered_signal, args.nfft, args.hop_length)
